...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.gakuranwiki.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Gakuran Wiki",
    description: "Read the Terms of Service for Gakuran Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "Gakuran Wiki",
      title: "Terms of Service - Gakuran Wiki",
      description: "Terms and conditions for using Gakuran Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Gakuran Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Gakuran Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Gakuran Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Gakuran Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Gakuran". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Codes, code status, and redeem system checks</li>
              <li>PvP, combat, and fighting style guides</li>
              <li>Controls and keybind references</li>
              <li>Map, locations, and school-town RP notes</li>
              <li>Updates, patch notes, and code changes</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Gakuran Wiki is NOT affiliated with, endorsed by, or associated with
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Gakuran Wiki and are protected by international
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> Roblox game updates may change without notice. We are not responsible for in-game changes or access issues.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, GAKURAN WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Gakuran Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@gakuranwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@gakuranwiki.wiki</a>
            </p>
            <p>
