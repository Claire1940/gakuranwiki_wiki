...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Gakuran Wiki',
    description: 'Copyright and intellectual property information for Gakuran Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Gakuran Wiki',
      description: 'Copyright and intellectual property information for Gakuran Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Gakuran Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Gakuran Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Gakuran Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
            ...
            <ul>
              ...
              <li><strong>Gakuran Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
            ...
            <p>
              ...
              Gakuran Wiki<br />
              Email: <a href="mailto:dmca@gakuranwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@gakuranwiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Gakuran Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Gakuran Wiki (gakuranwiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@gakuranwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@gakuranwiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@gakuranwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@gakuranwiki.wiki</a>
            </p>
            <p>
